          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="flex-1 text-center lg:text-left order-2 lg:order-2">
              <div className="space-y-8 animate-fade-in">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-3 max-w-lg">
                  {skills.map((skill) => (
                    <span
                      key={skill.name}
                      className="px-4 py-2 text-sm font-medium glass-card rounded-full flex items-center gap-2 hover:scale-105 transition-transform duration-300 border border-white/10"
                    >
              ...
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 pt-4">
                  ...
                  >
                  <a
                  href="https://drive.google.com/uc?export=download&id=1pubAj4IvELyqbCSGREDUtmRzVFfF6ny0"
                  target="_blank"
