...
const About = () => {
  ...
  return (
    <section id="about" className="py-24 bg-gradient-to-br from-background to-muted/20" ref={sectionRef}>
      <div className="section-container">
        <div className="max-w-6xl mx-auto">
          ...
          <div className={`grid lg:grid-cols-2 gap-16 items-center mb-20 ${sectionVisible ? 'scroll-visible animate-slide-up-delay-1' : 'scroll-hidden'}`}>
          ...
          <div className={`${sectionVisible ? 'scroll-visible animate-slide-up-delay-2' : 'scroll-hidden'}`}>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {achievements.map((achievement, index) => (
                <Card 
                  key={index} 
                  className={`glass-card text-center hover:shadow-xl transition-all duration-300 hover:scale-105 group ${
                    sectionVisible 
                      ? `scroll-visible animate-slide-up-delay-${Math.min(index + 3, 6)}` 
                      : 'scroll-hidden'
                  }`}
                >
